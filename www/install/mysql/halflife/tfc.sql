...
INSERT INTO `ps_config_awards` (`id`, `enabled`, `idx`, `type`, `negative`, `class`, `name`, `groupname`, `phrase`, `expr`, `order`, `where`, `limit`, `format`, `gametype`, `modtype`, `rankedonly`, `description`) 
    VALUES 
        ...
        (22,1,140,'player',0,'','Most Flags Captured','','{$player.link} has captured the most flags ({$award.value})','{$flagscaptured}','desc','',10,'commify','halflife','tfc',1,'Player has captured the most flags.'),
        ...
        (27,1,130,'player',0,'','Most Backstabs','','{$player.link} has the most sneaky backstabs ({$award.value})','{$backstabkills}','desc','',0,'commify','halflife','tfc',1,'Players that are sneaky and like to kill others from the shadows!'),
